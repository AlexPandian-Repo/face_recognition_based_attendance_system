...
class Student:
    def __init__(self, root):
        ...
        img1 = Image.open(r"C:\Users\dwayn\Desktop\fras\FinalYearProject\college_images\second.jpg")
        ...
        img2 = Image.open(r"C:\Users\dwayn\Desktop\fras\FinalYearProject\college_images\second.jpg")
        ...
        img3 = Image.open(r"C:\Users\dwayn\Desktop\fras\FinalYearProject\college_images\second.jpg")
        ...
        img4 = Image.open(r"C:\Users\dwayn\Desktop\fras\FinalYearProject\college_images\fourth.jpg")
        ...
        main_frame.place(x=10, y=55, width=1340, height=550)
        ...
        dep_combo = ttk.Combobox(current_course_frame, textvariable=self.var_dep, font=("times new roman", 12, "bold"),
                                 state="readonly")
        dep_combo['values'] = ("Select Department", "CSE", 'IT', 'ME', 'CE', 'CH')
        dep_combo.current(0)
        ...
        course_combo['values'] = ("Select Course", "Btech", 'MTech', 'MBA', 'BSc')
        ...
        class_student_frame = LabelFrame(left_frame, bd=2, bg="white", relief=RIDGE, text="Class Student Information",
                                         font=("times new roman", 12, "bold"))
        class_student_frame.place(x=5, y=170, width=700, height=300)
        ...
        radiobutton1 = ttk.Radiobutton(class_student_frame, variable=self.var_radio1, text="Take a photo Sample",
                                       value="Yes")
        ...
        save_btn = Button(btn_frame, text="Save", command=self.add_data, width=16, font=("times new roman", 12, "bold"),
                          bg="blue", fg="white")
        save_btn.grid(row=0, column=0)
        # update button==========
        update_btn = Button(btn_frame, command=self.update_data, text="Update", width=16,
                            font=("times new roman", 12, "bold"), bg="blue",
                            fg="white")
        update_btn.grid(row=0, column=1)
        # delete button===========
        delete_btn = Button(btn_frame, command=self.delete_data, text="Delete", width=16,
                            font=("times new roman", 12, "bold"), bg="blue",
                            fg="white")
        delete_btn.grid(row=0, column=2)
        # date reset button=========
        reset_btn = Button(btn_frame, command=self.reset_data, text="Reset", width=16,
                           font=("times new roman", 12, "bold"), bg="blue",
                           fg="white")
        ...
        take_photo_btn = Button(btn_frame, command=self.generate_dataset, text="Take Photo Sample", width=16,
                                font=("times new roman", 12, "bold"),
                                bg="blue",
                                fg="white")
        ...
        search_frame = LabelFrame(right_frame, bd=2, bg="white", relief=RIDGE, text="Search System",
                                  font=("times new roman", 12, "bold"))
        search_frame.place(x=5, y=20, width=640, height=100)
        ...
        # Search Btn============================
        search_btn = Button(search_frame, text="Search", width=8, font=("times new roman", 12, "bold"), bg="blue",
                            fg="white")
        search_btn.grid(row=0, column=3, padx=3)

        # Show All btn====================
        show_all_btn = Button(search_frame, text="Show ALL", width=8, font=("times new roman", 12, "bold"), bg="blue",
                              fg="white")
        show_all_btn.grid(row=0, column=4, padx=3)

        # Table Frame==================
        table_frame = Frame(right_frame, bd=2, bg="white", relief=RIDGE)
        table_frame.place(x=5, y=125, width=640, height=380)
    ...
    def delete_data(self):
        if self.var_std_id.get() == "":
            ...
            try:
                delete = messagebox.askyesno("Student Delete page", "Do you want to delete the student details",
                                             parent=self.root)
                if delete > 0:
                    conn = mysql.connector.connect(host="localhost", username="root", password="root",
                                                   database="face_recognizer")
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id == "":
            ...
            try:
                ...
                self.reset_data()
                conn.close()
                # ======================== Load pre defined data on the face frontal from opencv=========
